...
export default function Aprovisionamientos() {
  const config = contratarConfig.aprovisionamientos;
  ...
  return (
    <CategoryPage
      categoryName="Aprovisionamientos"
      categoryKey="aprovisionamientos"
      title="Aprovisionamientos"
      description="Encuentra proveedores y productos para el aprovisionamiento de tu negocio de hostelería"
      icon={Truck}
      config={config}
