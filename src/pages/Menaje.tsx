...
export default function Menaje() {
  ...
  // Filter anuncios for menaje category
  const menajeAnuncios = anuncios.filter(anuncio => 
    anuncio.categoria.toLowerCase() === 'menaje'
  );
  ...
  // Apply filters
  const filteredAnuncios = menajeAnuncios.filter(anuncio => {
    const matchesPrice = priceFilter === "todos" || 
      (priceFilter === "bajo" && anuncio.precio && parseInt(anuncio.precio) < 500) ||
      (priceFilter === "medio" && anuncio.precio && parseInt(anuncio.precio) >= 500 && parseInt(anuncio.precio) <= 1500) ||
      (priceFilter === "alto" && anuncio.precio && parseInt(anuncio.precio) > 1500);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Vajillas, cristalería, mantelería y todo el menaje para tu restaurante
          </p>
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <Select value={priceFilter} onValueChange={setPriceFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="bajo">Menos de €500</SelectItem>
              <SelectItem value="medio">€500 - €1,500</SelectItem>
              <SelectItem value="alto">Más de €1,500</SelectItem>
            </SelectContent>
          </Select>
        ...
        {filteredAnuncios.length > 0 ? (
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">
                No hay anuncios de menaje que coincidan con tus filtros
              </p>
              <Button 
                variant="outline" 
                className="mt-4"
