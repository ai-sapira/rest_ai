...
export default function Utensilios() {
  const config = contratarConfig.utensilios;
  ...
  return (
    <CategoryPage
      ...
      categoryKey="utensilios"
      title="Utensilios"
      description="Encuentra los utensilios de cocina que necesitas: cuchillos, sartenes, ollas, herramientas y más"
      icon={Utensils}
      config={config}
